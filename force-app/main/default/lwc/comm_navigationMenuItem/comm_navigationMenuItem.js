 ...
 */
export default class Comm_navigationMenuItem extends NavigationMixin(LightningElement) {
    /**
    ...
    handleClick(evt) {
        ...
        const itemClickedEvent = new CustomEvent('menuitemclicked');
