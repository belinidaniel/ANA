/**
 * @file A basic pub-sub mechanism for sibling component communication.
 ...
 * @returns {boolean} True if two pages referecens have the same attributes.
 */
 ...
 * @throws Exception if listener doesn't have a pageRef property.
 */
